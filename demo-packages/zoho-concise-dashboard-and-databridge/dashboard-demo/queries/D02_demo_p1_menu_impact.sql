-- Query Table: D02_demo_p1_menu_impact.sql
-- Purpose: Concise Page 1 menu impact table for the time-boxed visual demo.
-- Sources: 05_std_ct_inventory_snapshot.sql, 26_fact_ct_forecast_ingredient_demand.sql,
--          22_fact_ct_purchase_order.sql
-- Dependency level: 3
-- Isolation rule: Do not replace or edit Query 28. This query runs in parallel.
...
SELECT
    ...
    f."outlet_name" AS "filter_outlet",
