...
Install Ollama, copy this entire `local_data_auditor` folder to the machine, then
run once:
...
```bat
py -3 local_data_auditor\business_review.py --audit-run local_data_auditor\output\real_dump_semantic_20260723 --as-of 2026-07-23
```
