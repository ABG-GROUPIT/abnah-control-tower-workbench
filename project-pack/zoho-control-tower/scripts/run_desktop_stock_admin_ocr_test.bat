...
setlocal
cd /d "%~dp0.."
set "INPUT_DIR=%USERPROFILE%\OneDrive\Desktop\ABNAH_POSIST_SCREENSHOTS\p4_stock_admin"
if not exist "%INPUT_DIR%" set "INPUT_DIR=%USERPROFILE%\Desktop\ABNAH_POSIST_SCREENSHOTS\p4_stock_admin"
