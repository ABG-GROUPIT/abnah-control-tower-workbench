...
EXPECTED_DISCOVERY_BOUNDARY = {
    ...
    "strict_schema_only_images_retained": 98,
    "operational_value_images_excluded": 84,
    "schema_only_image_report_groups_covered": 65,
    "report_groups_pending_schema_only_image": 29,
    "pending_image_groups_with_verified_text_schema": 27,
    "pending_image_groups_still_text_pending": 2,
    "verified_text_schema_fields": 530,
    "text_cards_count_as_screenshots": False,
    "public_website_screenshot_assets": 0,
    "release_gate": "BLOCKED_PENDING_29_SAFE_IMAGES_AND_2_TEXT_SCHEMAS",
}
