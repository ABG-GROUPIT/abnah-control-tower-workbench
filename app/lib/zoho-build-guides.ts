...
const objectGuides: Record<string, DashboardObjectBuildGuide> = {
  "Net Sales": { visual: "KPI Widget", status: "Existing widget PRIVATE_CLIENT_BINDING", formatting: ["Currency: INR, 2 decimals"], acceptance: "Month 1, all outlets: INR 1,945,189.00 from 4,855 sales rows.", noData: "The selected physical period/outlet/menu scope has no sales rows." },
  "Theoretical Gross Margin": { visual: "KPI Widget", status: "Existing widget PRIVATE_CLIENT_BINDING", formatting: ["Currency: INR, 2 decimals"], acceptance: "Month 1, all outlets: INR 1,600,209.12 from 4,855 complete-recipe-cost sales rows.", noData: "The selected menu scope has no complete recipe-cost row." },
  ...
  "Open PO Liability": { visual: "KPI Widget", status: "Repair existing widget PRIVATE_CLIENT_BINDING", formatting: ["Currency: INR, 2 decimals", "GroupBy/Data Column: None"], acceptance: "31 Jan 2026: INR 202,722.30 across 54 open lines and 30 POs.", noData: "No eligible open-PO row exists in the selected compatible scope." },
