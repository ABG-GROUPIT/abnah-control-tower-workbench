    ...
    <div className="journey-extension">
      <header className="journey-extension-header">
        <div>
          ...
          <p>Source reconciliation remains PASS, but live conversational evidence is mixed: WAT 22 is {ziaWorkflowAcceptanceLedger.currentLedger}; the 66-test ladder is {ziaNaturalLanguageLadder.currentLedger}. The original semantic contract, ZLD009, corrected ZLD037 and the governed aggregate formula remain read back. Five purpose-separated helpers were created or edited in place, and the targeted smokes are complete. WAT06 and WAT07 remain partial, WAT08 produced no improvement, and WAT09 plus WAT11 functionally passed without schema-v1 receipts. Those functional smokes are not canonical passes: the ledgers remain unchanged, full reruns remain held, no workflow is presentation-ready and the gate remains BLOCKED.</p>
        </div>
